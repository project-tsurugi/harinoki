...
class TokenProviderTest {
    ...
    @Test
    void access() {
        Algorithm algorithm = Algorithm.RSA256(TokenProviderFactory.createPublicKey(TestConstants.publicKey()), TokenProviderFactory.createPrivateKey(TestConstants.privateKey()));
        var provider = new TokenProvider(
                ...
                algorithm,
                TokenProviderFactory.createPrivateKey(TestConstants.privateKey()),
